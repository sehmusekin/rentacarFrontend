    ...
    <div>
      <div className="container my-24 mx-auto md:px-6">
        <section className="mb-32 text-center">
          <h2 className="mb-12 text-3xl font-bold">Görüşler</h2>
          ...
          <div className="grid gap-x-6 md:grid-cols-3 xl:gap-x-12">
            <div className="mb-6 lg:mb-0">
              <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                <div className="relative overflow-hidden bg-cover bg-no-repeat">
                  <img
                    src="https://r.resimlink.com/jYqRwlFe5ax.jpg"
                ...
                <div className="relative overflow-hidden bg-cover bg-no-repeat">
                  <img
                    src="https://r.resimlink.com/Vctx3O0zlQS.jpg"
                    className="w-full rounded-t-lg"
                  />
                  <a href="#!">
                    <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed"></div>
                ...
                <div className="p-6">
                  <h5 className="mb-2 text-lg font-bold">Şehmus EKİN </h5>
            ...
            <div className="mb-6 lg:mb-0">
              <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                <div className="relative overflow-hidden bg-cover bg-no-repeat">
                  <img
                    src="https://r.resimlink.com/dP0hsDM.webp"
                    className="w-full rounded-t-lg"
                  />
                  <a href="#!">
                    <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed"></div>
                ...
                <div className="p-6">
                  <h5 className="mb-2 text-lg font-bold">Harun YILMAZ</h5>
                  <h6 className="mb-4 font-medium text-primary dark:text-primary-400">
                    Web Developer
                  </h6>
                  <ul className="mb-6 flex justify-center">
